...
class SerieSearchDelegate_log extends SearchDelegate {
  @override
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    return StreamBuilder(
      ...
      //ESTE ES EN EL CASO DE FUTURE BUILDER
      //FutureBuilder<List<Series>>
      //future: servicioserie.BuscarSerie(query),
    ...
    return ListTile(
      ...
      onTap: () async {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Details_Screen(lista: serielista),
          ),
        );
      },
    );
